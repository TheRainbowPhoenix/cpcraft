...
int main() {
  tlsf =
      tlsf_create_with_pool((char *)(0x8C400000 + ALLOC_OFFSET), 1024 * 1024);
  ...
  // renderTriangleTexturedNBPX2T((Vector2I){5, 5}, (Vector2I){55, 5},
  // (Vector2I){55, 55}, (Vector2I){0, 0}, (Vector2I){10, 0}, (Vector2I){10,
  // 10}, 50000-j, 16, 16, &textures[0]);
  ...
  if (GetVRAMAddress() == 0xAC000000) {
    ...
    renderText(10, 25,
               "CG10/CG20 does not have phython heap and this version uses "
               "phython heap.");
    renderText(10, 40,
               "Please download the verison that was designed for your device");
